...
#| fig-cap: The credible intervals for coefficient estimates of predictors of a game wins GOTY
#| echo: false
#| warning: false
#| message: false

# Specify credible interval to be 90% and present model results
# modelplot(bayesian_model, conf_level = 0.9) +
...
Trace plot @fig-trace shows generally overlapping chains and @fig-rhat also shows values close to 1.0 for all parameters indicate good convergence. I didn't conduct residual vs. fitted and VUC checks because of the class imbalance of dataset.
