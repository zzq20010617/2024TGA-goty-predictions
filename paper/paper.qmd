---
title: "Predicting The Game Award for Game of the Year 2024: Analyzing Trends and Ratings in the Video Game Industry (2014–2024)"
subtitle: "A Logistic Regression Approach Using User and Critic Data on Metacritic to Forecast the 2024 GOTY Winner"
author: 
  - Ziqi Zhu
...
We run the model in R [@citeR] using the `rstanarm` package of @rstanarm. We use the default priors from `rstanarm`, reflecting no strong assumptions about the weight of each predictors' effects.
